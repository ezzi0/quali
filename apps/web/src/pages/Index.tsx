...
import QualificationWidget from '@/components/qualification/QualificationWidget';
        ...
        <div className="flex-1 flex flex-col justify-end items-start relative z-20">
          <div className="container-wide pb-16 lg:pb-24 pt-32 w-full">
            <div className="max-w-xl">
              ...
              <Link to="/qualification" className="text-sm text-white/70 hover:text-white">
                Talk to the qualification assistant →
              </Link>
            </div>
          </div>
        </div>

        <div className="absolute right-6 bottom-8 z-30 hidden lg:block">
          <QualificationWidget />
        </div>
      </section>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              {siteAssets.officeTeam ? (
                <img src={siteAssets.officeTeam} alt="Professional office environment" className="rounded-2xl w-full h-auto" />
              ) : (
                <div className="rounded-2xl w-full h-64 bg-muted flex items-center justify-center text-muted-foreground">
                  Image pending
                </div>
              )}
            </div>
